...
const ProductDetailPage = () => {
  ...
  const handleBuyClick = async () => {
    // Verifica se o usuário está logado antes de tentar comprar
  ...
  const handleClientRegistrationSuccess = async () => {
    // Fecha o modal após cadastro bem-sucedido
    setIsClientModalOpen(false);

    // Adiciona o produto ao pedido após o cadastro do cliente
    if (product) {
      try {
      ...
      <Stack spacing={{ xs: 6, md: 10 }} pb={{ xs: 8, md: 12 }}>
        ...
        >
          ...
          >
            ...
            <Stack
              spacing={0}
              sx={{ mx: { xs: 1, md: '145px' }, maxWidth: '100%', overflowX: 'hidden' }}
            >
              {/* Fragrância */}
                ...
                >
                  ...
                  <AccordionDetails sx={{ px: 1.25, py: 2 }}>
                    ...
                    >
                      ...
                      <br />
                      <strong>Notas de saída:</strong>{' '}
                      {product.fragranceDetails.topNotes.join(', ')}
                      <br />
                      <strong>Notas de corpo:</strong>{' '}
                      {product.fragranceDetails.middleNotes.join(', ')}
                      <br />
                      <strong>Notas de fundo:</strong>{' '}
                      {product.fragranceDetails.baseNotes.join(', ')}
                      <br />
            ...
            >
              ...
              >
                <Divider
                  sx={{
                    flexGrow: { xs: 0, md: 0 },
                    width: { xs: '10%', sm: '15%', md: 610 },
                    maxWidth: { xs: '20%', md: 'none' },
